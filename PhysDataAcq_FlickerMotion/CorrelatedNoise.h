...
int GenCorrelatedNoiseHex_v2(const int sd, int Pixels, int nRowsHigh, int nRowsLow, int nColsHigh, int nColsLow,  int frameCt, int frameLag, int xLag, int yLag, int framePersist, float alpha1, float alpha2, float alpha3, int16 *Loc1, int16*Loc2, unsigned short int *memAssignRandInt1, unsigned short int *memAssignRandInt2, unsigned short int *memAssignAddedNoise, unsigned short int *memAssignMask, float pairProp, int PPPTrial, int nframes); //changed int* => int16* for Loc1, Loc2 to match rest of code [11/10/2017], int PPTrial added for PPP [11/14/2017]; added int nframes [5/18/2018]
