...
MenuReturnValues::MenuReturnValues()
{
	...
	//dStimTimeOut		= -1.0;
	//bStimAutoStart		= 0;
	iStimBufferSize		= 2048; // re-included to avoid warning; [AWT], [4/27/2018]
	...
	strStimFileDirPath	= string("D:\\Scripts\\PhysDataAcqScripts\\TestFolder_AWT_2017");
	...
	dStimSampRate		= 1250000; //A to D sample rate (?)
	dStimMinVoltVal		= -5.0;
	dStimMaxVoltVal		= 5.0;
	iNumRepeats			= 1;
	iNumNIAOChans		= 3;
