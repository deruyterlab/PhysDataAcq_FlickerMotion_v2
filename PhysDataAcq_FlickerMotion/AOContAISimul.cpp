...
void AOContAISimul( MenuReturnValues mValues )
{
	// General parameters
	...
	uInt32		SampPerChan_RespBuf		= 0;	// ONE KEY TO THIS CODE WORKING IS THAT THE DIGITAL BUFFER BE > 2046 SAMPLES
	uInt32		SampPerChan_HalfRespBuf	= 0;
...
Error:
	...
	/*********************************************/
	// Close files and DAQmx Reset Device
	/*********************************************/
	ptrAIFile->close();
	ptrAOFile->close();
	DAQmxErrChk (DAQmxResetDevice("Dev1"));
